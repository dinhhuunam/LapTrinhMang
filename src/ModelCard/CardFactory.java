...
public class CardFactory {
	...
	public String src = "E:\\GitHub\\Game-Danh-Bai-Tien-Le-Java-Socket-TCP-MultiThread-Java-Swing--main\\Resource\\";
	...
	public void createOriginalCard() {
		...
		// họ nhà tép
		originalCardList.add(new Card(0, "tep", "3", src+"3tep.png"));
		originalCardList.add(new Card(1, "tep", "4", src+"4tep.png"));
		originalCardList.add(new Card(2, "tep", "5", src+"5tep.png"));
		originalCardList.add(new Card(3, "tep", "6", src+"6tep.png"));
		originalCardList.add(new Card(4, "tep", "7", src+"7tep.png"));
		originalCardList.add(new Card(5, "tep", "8", src+"8tep.png"));
		originalCardList.add(new Card(6, "tep", "9", src+"9tep.png" ));
		originalCardList.add(new Card(7, "tep", "10", src+"10tep.png"));
		originalCardList.add(new Card(8, "tep", "J", src+"Jtep.png"));
		originalCardList.add(new Card(9, "tep", "Q", src+"Qtep.png"));
		originalCardList.add(new Card(10, "tep", "K", src+"Ktep.png"));
		originalCardList.add(new Card(11, "tep", "A", src+"Atep.png"));
		originalCardList.add(new Card(12, "tep", "2", src+"2tep.png"));
		
		// họ nhà rô
		originalCardList.add(new Card(13, "ro", "3", src+"3ro.png"));
		originalCardList.add(new Card(14, "ro", "4", src+"4ro.png"));
		originalCardList.add(new Card(15, "ro", "5", src+"5ro.png"));
		originalCardList.add(new Card(16, "ro", "6", src+"6ro.png"));
		originalCardList.add(new Card(17, "ro", "7", src+"7ro.png"));
		originalCardList.add(new Card(18, "ro", "8", src+"8ro.png"));
		originalCardList.add(new Card(19, "ro", "9", src+"9ro.png"));
		originalCardList.add(new Card(20, "ro", "10", src+"10ro.png"));
		originalCardList.add(new Card(21, "ro", "J", src+"Jro.png"));
		originalCardList.add(new Card(22, "ro", "Q", src+"Qro.png"));
		originalCardList.add(new Card(23, "ro", "K", src+"Kro.png"));
		originalCardList.add(new Card(24, "ro", "A", src+"Aro.png"));
		originalCardList.add(new Card(25, "ro", "2", src+"2ro.png"));
		
		// họ nhà cơ
		originalCardList.add(new Card(26, "co", "3", src+"3co.png"));
		originalCardList.add(new Card(27, "co", "4", src+"4co.png"));
		originalCardList.add(new Card(28, "co", "5", src+"5co.png"));
		originalCardList.add(new Card(29, "co", "6", src+"6co.png"));
		originalCardList.add(new Card(30, "co", "7", src+"7co.png"));
		originalCardList.add(new Card(31, "co", "8", src+"8co.png"));
		originalCardList.add(new Card(32, "co", "9", src+"9co.png"));
		originalCardList.add(new Card(33, "co", "10", src+"10co.png"));
		originalCardList.add(new Card(34, "co", "J", src+"Jco.png"));
		originalCardList.add(new Card(35, "co", "Q", src+"Qco.png"));
		originalCardList.add(new Card(36, "co", "K", src+"Kco.png"));
		originalCardList.add(new Card(37, "co", "A", src+"Aco.png"));
		originalCardList.add(new Card(38, "co", "2", src+"2co.png"));
		
		// họ nhà bích
		originalCardList.add(new Card(39, "bich", "3", src+"3bich.png"));
		originalCardList.add(new Card(40, "bich", "4", src+"4bich.png"));
		originalCardList.add(new Card(41, "bich", "5", src+"5bich.png"));
		originalCardList.add(new Card(42, "bich", "6", src+"6bich.png"));
		originalCardList.add(new Card(43, "bich", "7", src+"7bich.png"));
		originalCardList.add(new Card(44, "bich", "8", src+"8bich.png"));
		originalCardList.add(new Card(45, "bich", "9", src+"9bich.png"));
		originalCardList.add(new Card(46, "bich", "10", src+"10bich.png"));
		originalCardList.add(new Card(47, "bich", "J", src+"Jbich.png"));
		originalCardList.add(new Card(48, "bich", "Q", src+"Qbich.png"));
		originalCardList.add(new Card(49, "bich", "K", src+"Kbich.png"));
		originalCardList.add(new Card(50, "bich", "A", src+"Abich.png"));
		originalCardList.add(new Card(51, "bich", "2", src+"2bich.png"));
	}
	...
	public void createPickedCard() {
		...
		originalPickedCardList.add(new Card(0, "tep", "3", src+"3teppicked.png"));
		originalPickedCardList.add(new Card(1, "tep", "4", src+"4teppicked.png"));
		originalPickedCardList.add(new Card(2, "tep", "5", src+"5teppicked.png"));
		originalPickedCardList.add(new Card(3, "tep", "6", src+"6teppicked.png"));
		originalPickedCardList.add(new Card(4, "tep", "7", src+"7teppicked.png"));
		originalPickedCardList.add(new Card(5, "tep", "8", src+"8teppicked.png"));
		originalPickedCardList.add(new Card(6, "tep", "9", src+"9teppicked.png" ));
		originalPickedCardList.add(new Card(7, "tep", "10", src+"10teppicked.png"));
		originalPickedCardList.add(new Card(8, "tep", "J", src+"Jteppicked.png"));
		originalPickedCardList.add(new Card(9, "tep", "Q", src+"Qteppicked.png"));
		originalPickedCardList.add(new Card(10, "tep", "K", src+"Kteppicked.png"));
		originalPickedCardList.add(new Card(11, "tep", "A", src+"Ateppicked.png"));
		originalPickedCardList.add(new Card(12, "tep", "2", src+"2teppicked.png"));
		
		// picked card nhà họ rô
		originalPickedCardList.add(new Card(13, "ro", "3", src+"3ropicked.png"));
		originalPickedCardList.add(new Card(14, "ro", "4", src+"4ropicked.png"));
		originalPickedCardList.add(new Card(15, "ro", "5", src+"5ropicked.png"));
		originalPickedCardList.add(new Card(16, "ro", "6", src+"6ropicked.png"));
		originalPickedCardList.add(new Card(17, "ro", "7", src+"7ropicked.png"));
		originalPickedCardList.add(new Card(18, "ro", "8", src+"8ropicked.png"));
		originalPickedCardList.add(new Card(19, "ro", "9", src+"9ropicked.png"));
		originalPickedCardList.add(new Card(20, "ro", "10", src+"10ropicked.png"));
		originalPickedCardList.add(new Card(21, "ro", "J", src+"Jropicked.png"));
		originalPickedCardList.add(new Card(22, "ro", "Q", src+"Qropicked.png"));
		originalPickedCardList.add(new Card(23, "ro", "K", src+"Kropicked.png"));
		originalPickedCardList.add(new Card(24, "ro", "A", src+"Aropicked.png"));
		originalPickedCardList.add(new Card(25, "ro", "2", src+"2ropicked.png"));
		
		// picked card nhà họ cơ
		originalPickedCardList.add(new Card(26, "co", "3",src+"3copicked.png"));
		originalPickedCardList.add(new Card(27, "co", "4", src+"4copicked.png"));
		originalPickedCardList.add(new Card(28, "co", "5", src+"5copicked.png"));
		originalPickedCardList.add(new Card(29, "co", "6", src+"6copicked.png"));
		originalPickedCardList.add(new Card(30, "co", "7", src+"7copicked.png"));
		originalPickedCardList.add(new Card(31, "co", "8", src+"8copicked.png"));
		originalPickedCardList.add(new Card(32, "co", "9", src+"9copicked.png"));
		originalPickedCardList.add(new Card(33, "co", "10", src+"10copicked.png"));
		originalPickedCardList.add(new Card(34, "co", "J", src+"Jcopicked.png"));
		originalPickedCardList.add(new Card(35, "co", "Q",src+ "Qcopicked.png"));
		originalPickedCardList.add(new Card(36, "co", "K",src+"Kcopicked.png"));
		originalPickedCardList.add(new Card(37, "co", "A", src+"Acopicked.png"));
		originalPickedCardList.add(new Card(38, "co", "2", src+"2copicked.png"));
		
		// picked card nhà họ bích
		originalPickedCardList.add(new Card(39, "bich", "3", src+"3bichpicked.png"));
		originalPickedCardList.add(new Card(40, "bich", "4", src+"4bichpicked.png"));
		originalPickedCardList.add(new Card(41, "bich", "5", src+"5bichpicked.png"));
		originalPickedCardList.add(new Card(42, "bich", "6",src+ "6bichpicked.png"));
		originalPickedCardList.add(new Card(43, "bich", "7",src+ "7bichpicked.png"));
		originalPickedCardList.add(new Card(44, "bich", "8", src+"8bichpicked.png"));
		originalPickedCardList.add(new Card(45, "bich", "9",src+ "9bichpicked.png"));
		originalPickedCardList.add(new Card(46, "bich", "10", src+"10bichpicked.png"));
		originalPickedCardList.add(new Card(47, "bich", "J", src+"Jbichpicked.png"));
		originalPickedCardList.add(new Card(48, "bich", "Q", src+"Qbichpicked.png"));
		originalPickedCardList.add(new Card(49, "bich", "K", src+"Kbichpicked.png"));
		originalPickedCardList.add(new Card(50, "bich", "A", src+"Abichpicked.png"));
		originalPickedCardList.add(new Card(51, "bich", "2", src+"2bichpicked.png"));
	}
	
	public void createHideCard() {
		hideCard = new Card(100, "hide", "hideside", src+"hideside.png");
	}
